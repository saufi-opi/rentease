      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <motion.div 
            ...
            className="lg:w-1/3"
          >
            <Badge className="mb-4 bg-primary text-primary-foreground border-none px-4 py-1">Features</Badge>
            <h2 className="mb-6 text-4xl font-extrabold text-background tracking-tight leading-tight">
              Why Choose <span className="text-primary italic">RentEase</span> for Your Next Trip?
            </h2>
            <p className="text-background/60 text-lg mb-8 leading-relaxed">
              We provide a premium experience that goes beyond just car rentals. Our commitment to quality and customer satisfaction is what sets us apart.
            </p>
          ...
          >
            {reasons.map((reason, index) => (
              ...
              >
                ...
                <h3 className="mb-3 text-xl font-bold text-background group-hover:text-primary transition-colors">{reason.title}</h3>
                <p className="text-background/50 leading-relaxed">{reason.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
