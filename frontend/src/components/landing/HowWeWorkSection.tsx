...
const steps = [
  {
    ...
    description:
      "Select your preferred pickup location from our wide network of stations.",
  },
  {
    icon: Calendar,
    title: "Pick up date",
  ...
  },
  {
    ...
    title: "Book your car",
    description:
      "Browse available cars and complete your booking in just a few clicks.",
  },
]
    ...
    <section className="bg-background py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <h2 className="mb-4 text-4xl font-extrabold text-foreground tracking-tight">
            How it works?
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg text-balance">
            Follow these simple steps to get your perfect ride. We've
            streamlined the process so you can spend less time booking and more
            time driving.
          </p>
        </motion.div>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="relative z-10 space-y-3">
                  ...
                  <p className="text-muted-foreground leading-relaxed text-balance px-4">
                    {step.description}
                  </p>
                </div>
              </motion.div>
