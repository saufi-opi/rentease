      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            <Link
              to="/"
              className="mb-4 inline-block transition-all hover:opacity-80"
            >
              <Logo iconSize="h-6" fontSize="text-xl text-primary" />
            </Link>
            <p className="mb-4 text-sm text-background/70">
              Your trusted partner for car rentals. Discover freedom on wheels
              with our wide selection of vehicles.
            </p>
