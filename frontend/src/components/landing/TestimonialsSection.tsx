...
const testimonials = [
  {
    ...
    rating: 5,
    review:
      "Excellent service! The car was clean and well-maintained. Will definitely use RentEase again for my next trip.",
  },
  {
    id: 2,
    name: "Sarah Johnson",
    ...
    rating: 5,
    review:
      "Very smooth booking process and the customer support was incredibly helpful. Highly recommended!",
  },
  {
    id: 3,
    name: "Mike Chen",
    ...
    rating: 4,
    review:
      "Great prices compared to other rental services. The pickup was quick and hassle-free.",
  },
]
