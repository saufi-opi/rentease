        ...
        {favoriteVehicles.length > 0 ? (
          favoriteVehicles.map((vehicle, index) => (
            ...
            >
              <div className="relative group">
                ...
                />
                <button className="absolute top-3 right-3 p-2 rounded-full bg-background/80 hover:bg-background transition-colors shadow-sm z-10">
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button
                      ...
                      asChild
                    >
                      <Link to={`/cars/${vehicle.id}/book` as any}>
                        Book Now
                      </Link>
                    </Button>
                  </div>
          ...
          <div className="col-span-full py-16 flex flex-col items-center justify-center text-center border-2 border-dashed rounded-xl border-border bg-muted/10">
            ...
            <p className="text-muted-foreground mt-2 max-w-md mx-auto">
              You haven't saved any vehicles to your favourites. Browse our cars
              and click the heart icon to save them here for quick access!
            </p>
