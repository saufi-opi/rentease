            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex h-16 w-16 items-center justify-center rounded-xl bg-primary">
                  <span className="text-2xl font-bold text-primary-foreground">RENT</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <div className="flex w-full items-center justify-center px-8 lg:w-1/2">
        ...
        >
          ...
          <h1 className="mb-8 text-center text-2xl font-bold text-foreground">
            YOUR ADVENTURE'S<br />START HERE
          </h1>
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className="flex items-center justify-between">
                      ...
                      <RouterLink to="." className="text-xs text-primary hover:underline">Forgot password?</RouterLink>
                    </div>
                    <FormControl>
                      <PasswordInput
                        placeholder="••••••••"
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            ...
            <RouterLink to="/signup" className="font-semibold text-primary hover:underline underline-offset-4">
              Create an account
            </RouterLink>
          </p>
        </motion.div>
